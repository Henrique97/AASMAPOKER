...
for i in range(0, 60):
	...
	df1.to_csv("job3/3gameAllroundsP1" + str(i) + ".csv")
	df2.to_csv("job3/3gameAllroundsP2"+ str(i) + ".csv")
	df3.to_csv("job3/3gameAllroundsP3"+ str(i) + ".csv")

df.to_csv("job3/3gameresults.csv")
