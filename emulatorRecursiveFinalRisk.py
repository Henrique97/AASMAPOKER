...
monte_carlos_tries=[[0.9,1.0,100],[0.8,1.0,100],[0.7,1.0,100],[0.6,1.0,100],[0.6,1.0,100],[0.5,1.0,100],[0.4,1.0,100],[0.3,1.0,100],[0.2,1.0,100],[0.1,1.0,100]]
for tryM in monte_carlos_tries:
	...
	for i in range(0,2):
		...
		df1.to_csv("recJob5/gameAllroundsP1_try_" + str(tryM[0]) + "_game_" + str(i) + ".csv")
		df2.to_csv("recJob5/gameAllroundsP2_try_"+ str(tryM[0]) + "_game_" + str(i) + ".csv")
		df3.to_csv("recJob5/gameAllroundsP3_try_"+ str(tryM[0]) + "_game_" + str(i) + ".csv")
		df4.to_csv("recJob5/gameAllroundsP4_try_"+ str(tryM[0]) + "_game_" + str(i) + ".csv")
	df.to_csv("recJob5/gameresults_try" + str(tryM[0]) + ".csv")
	j+=1
